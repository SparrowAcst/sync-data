...
module.exports = async (syncOrg, syncPatientPattern, mode) => {
  ...
  logger.info(`SYNC DATA STARTS (${mode})`)
...
//////////////////////////////////////////////////////////////////////////////////////////////////// 
    ...
    for( let i = 0; i < syncExams.length; i++){
      ...
      // console.log("examination", JSON.stringify(examination.$extention, null, " "))
...
/////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    let readyForAccept = (mode == "validate") ? syncExams.filter(exam => exam._validation === true) : syncExams
...
////////////////////////////////////////////////////////////////////////////////////////////////////////
      ...
      console.log(JSON.stringify(labelOps, null, " "))
